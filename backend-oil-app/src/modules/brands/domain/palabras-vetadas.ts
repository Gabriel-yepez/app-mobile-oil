...
const VETADAS: readonly string[] = [
  ...
  'MIERDA', 'PENDEJO', 'PENDEJA', 'CARAJO', 'CABRON', 'CABRONA',
  'GILIPOLLAS', 'CAPULLO', 'CHINGAR', 'CHINGADA', 'JODER', 'JODIDO',
  'PUTA', 'PUTO', 'PUTOS', 'PUTAS', 'PERRA', 'ZORRA', 'MALPARIDO',
  'HIJUEPUTA', 'HIJUEPUTAS', 'HDP', 'CONO', 'VERGA', 'VERGAZO',
  'GUEVON', 'HUEVON', 'GUEBON', 'MARICO', 'MARICA', 'MARICON',
  'CULO', 'CULERO', 'PINGA', 'POLLA', 'PICHA', 'CHIMBO', 'CHIMBA',
  'COGER', 'COGIDA', 'TETAS', 'CONCHUDO', 'CONCHASUMADRE',
  'GONORREA', 'MALDITO', 'ESTUPIDO', 'IMBECIL', 'IDIOTA',
  // Inglés
  'FUCK', 'FUCKING', 'SHIT', 'BITCH', 'ASSHOLE', 'BASTARD',
  'CUNT', 'DICK', 'PUSSY', 'WHORE', 'SLUT', 'NIGGA', 'NIGGER',
  'FAGGOT', 'RETARD', 'RAPE',
];
